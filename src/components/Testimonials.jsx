...
const testimonials = [
  {
    ...
    text: "Un travail exceptionnel ! Lontsie n’a pas seulement développé une application élégante, il a également apporté des idées précieuses qui ont considérablement amélioré l’expérience utilisateur. Je le recommande vivement pour tout type de projet.",
    stars: 5,
  ...
  },
  {
    ...
    company: "KG-Code",
    text: "La capacité de Lontsie à transformer des exigences complexes en solutions élégantes est impressionnante. Il a livré une application évolutive qui a nettement amélioré l’efficacité de notre flux de travail.",
    stars: 5,
    avatar: "src/assets/hero.png",
  },
  {
    ...
    text: "boris a été un excellent atout pour notre équipe. Son attention aux bonnes pratiques de sécurité, sa capacité à collaborer et son sérieux dans la livraison ont rendu le projet fluide et réussi. Je le recommande pour tout travail de développement.",
    stars: 5,
